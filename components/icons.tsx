...
export const CaretLeft: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const PaperPlane: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const Microphone: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const DotsThreeHorizontal: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const DotOutline: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const NotePencil: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const ShareNetwork: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const Repeat: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const Divider: React.FC<IconSvgProps> = ({
  size = 32,
  width,
  height,
  ...props
